...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 14.117; //15.50; // 16.34; // in
     ...
     * empirically tuned.
     */
    public static double kV = 1.0 / rpmToVelocity(MAX_RPM); // 0.00308 // 1.0
    public static double kA = 0.002; //0.002;
    public static double kStatic = 0.35170; //0.34831;
    ...
    public static double MAX_ANG_VEL = Math.toRadians(415.98459316322436); // 184.02607784577722
